...
function MainPanel({ theme, level, selectedPage, content, pageHtmlContent, status, selectedNotebook, selectedSection }) {
  return (
    <Suspense fallback={<div className="w-full text-center py-8 text-lg text-blue-400">Loading panel...</div>}>
      <div className={
        theme === 'dark'
